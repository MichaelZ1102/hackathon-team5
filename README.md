...
| `services/risk_engine.py` | Python 版风险评分逻辑 |
| `services/content_generator.py` | mock/template 自然语言内容生成 |
| `services/data_loader.py` | JSON 数据读取和写入 |
| `storage/confirmed_work_orders.json` | 用户确认后的 mock 工单 |
| `README.md` | Flask API 使用说明 |
